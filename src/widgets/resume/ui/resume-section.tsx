  ...
  return (
    <section className="relative mx-auto px-4 py-[3.75rem] max-w-[75rem]">
      <div className="absolute left-1/2 top-[40.5rem] md:top-[27rem] w-[48.78125rem] overflow-hidden -translate-x-[16rem] md:-translate-x-[16rem]">
        <img src={bigringsImage} alt="" className="w-full h-full object-contain" />
      </div>
      <div className="relative mb-[1.25rem] text-center">
        ...
        >
          <img src={ringsImage} alt="Декоративные кольца" className="w-full h-full object-contain" />
        </div>
      ...
      <div className="flex justify-center items-center gap-[1.875rem] md:gap-[1.25rem] mb-[1.25rem]">
        <div className="rounded-full w-[16.6875rem] md:w-[11.125rem] h-[17.25rem] md:h-[11.55rem]">
          <img src={fotoImage} alt="Полина Мигранова" className="relative w-full h-full object-cover" />
        </div>
      ...
      <div className="ml-[29.8125rem] md:ml-[31.875rem]">
        <div className="mb-[5.5rem] md:mb-[3rem]">
          ...
          <ul className="font-extralight text-[3.28125rem] md:text-[2.1875rem] list-none relative">
            <li className="mb-[0.75rem] md:mb-[0.1rem]">
              <span className="-left-[4.71rem] md:-left-[3.14rem] absolute font-onest font-thin">&rarr;</span> PowerPoint
            </li>
            <li className="mb-[0.75rem] md:mb-[0.1rem]">
              <span className="-left-[4.71rem] md:-left-[3.14rem] absolute font-onest font-thin">&rarr;</span> Figma
            </li>
            <li>
              <span className="-left-[4.71rem] md:-left-[3.14rem] absolute font-onest font-thin">&rarr;</span> Photoshop,<br />Illustrator, InDesign
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="font-extralight text-[3.28125rem] md:text-[2.1875rem] list-none relative">
            <li className="mb-[0.75rem] md:mb-[0.1rem]">
              <span className="-left-[4.71rem] md:-left-[3.14rem] absolute font-onest font-thin">&rarr;</span> Системность
            </li>
            <li className="mb-[0.75rem] md:mb-[0.1rem]">
              <span className="-left-[4.71rem] md:-left-[3.14rem] absolute font-onest font-thin">&rarr;</span> Креативность
            </li>
            <li>
              <span className="-left-[4.71rem] md:-left-[3.14rem] absolute font-onest font-thin">&rarr;</span> Ответственность
            </li>
          </ul>
        </div>
      </div>
